...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="assets/logosUrl.png" type="image/png">
  </head>
  <body>
    <!--Navbar-->
   <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary shadow-sm justify-space-between">
  <div class="container-fluid">
    <img src="assets/logoNavbar.png" alt="logo" width="120px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Perpus</span>Online</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan <span class="fw-bold">PERPUSONLINE</span> Membawa Anda ke Dunia Buku Digital."</p>
          <a class="btn btn-primary" href="sign/link_login.html">Get started</a>
        </div>
        <div class="col mt-3">
          <img src="assets/logoDashboards-transformeds.png" width="450px">
        </div>
      </div>
    </section>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Nydia safira N</div>
        <div class="card-body">
          <h5 class="card-title">Student at SMK N 8 semarang</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      <div class="row">
        <div class="col">
          <img src="assets/logoFooters.png" width="200px">
        </div>
      </div>
      <div class="row p-3">
        <div class="col mt-3">
          <h3 class="text-light fs-5">Alamat</h3>
          <p class="text-secondary fs-6">JL Muter Muter Semarang</p>
        </div>
        <hr class="text-light mt-3">
        <div class="d-flex justify-content-center gap-4">
          <a href="" class="fs-3"><i class="fa-brands fa-github"></i></a>
          <a href="https://www.instagram.com/nydsfrn_?igsh=MXZ1bWRxd2IxaHFpZw==" class="fs-3"><i class="fa-brands fa-instagram"></i></a>
        </div>
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Nydia Safira N</a>  2024</p>
        </div>
      </div>
    </footer>
